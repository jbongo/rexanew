...
<div class="card alert">
            ...
            <div class="card-body">
                ...
                <form class="form-valide" action="{{route('updateFeed',$feedback->id)}}" method="post">
                    {{ csrf_field() }}
                        <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <select class="js-select2 form-control {{$errors->has('secteur') ? 'is-invalid' : ''}}" id="secteur" name="secteur" style="width: 100%;" data-placeholder="Choose one.." required>
                                            ...
                                            @if($feedback->secteur)
                                            <option value="{{$feedback->secteur}}">{{$feedback->secteur}}</option>
                                            @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control {{ $errors->has('pays') ? ' is-invalid' : '' }}" value="{{$feedback->pays}}" id="pays" name="pays" placeholder="Entez une lettre et choisissez.." required>
                            @if ($errors->has('pays'))
                                <br>
                                <div class="alert alert-warning ">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control {{ $errors->has('titre') ? ' is-invalid' : '' }}" value="{{$feedback->titre}}" id="titre" name="titre" placeholder="" required>
                                @if ($errors->has('titre'))
                                    <br>
                                    <div class="alert alert-warning ">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <textarea class="form-control" id="feedback" name="feedback"  rows="5" placeholder="" >{{old('feedback') ? old('feedback') : $feedback->description}}</textarea>
